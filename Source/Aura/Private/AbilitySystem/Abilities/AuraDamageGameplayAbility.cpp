...
FDamageEffectParams UAuraDamageGameplayAbility::MakeDaamgeEffectParamsFromClassDefaults(AActor* TargetActor) const
{
	...
	DamageEffectParams.Level = GetAbilityLevel();
	DamageEffectParams.BaseDamage = Damage.GetValueAtLevel(GetAbilityLevel());
	DamageEffectParams.DamagTypeTag = DamageTypeTag;
